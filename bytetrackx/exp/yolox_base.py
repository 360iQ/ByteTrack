...
class Exp(BaseExp):
    def __init__(self):
        ...
        # If set to False, bytetrackx will only save latest and best ckpt.
    ...
    def get_model(self):
        from bytetrackx.models import YOLOX, YOLOPAFPN, YOLOXHead
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        """
        from bytetrackx.data import COCODataset, TrainTransform
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img: str = None):
        ...
        from bytetrackx.utils import wait_for_the_master
    ...
    def get_lr_scheduler(self, lr, iters_per_epoch):
        from bytetrackx.utils import LRScheduler
    ...
    def get_eval_dataset(self, **kwargs):
        from bytetrackx.data import COCODataset, ValTransform
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, legacy=False):
        from bytetrackx.evaluators import COCOEvaluator
    ...
    def get_trainer(self, args):
        from bytetrackx.core import Trainer
