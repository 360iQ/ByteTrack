...
_CKPT_FULL_PATH = {
    "bytetrackx-nano": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_nano.pth",
    "bytetrackx-tiny": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_tiny.pth",
    "bytetrackx-s": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_s.pth",
    "bytetrackx-m": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_m.pth",
    "bytetrackx-l": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_l.pth",
    "bytetrackx-x": f"{_CKPT_ROOT_URL}/0.1.1rc0/yolox_x.pth",
...
def create_yolox_model(name: str, pretrained: bool = True, num_classes: int = 80, device=None,
    ...
    Args:
        name (str): name of model. for example, "bytetrackx-s", "bytetrackx-tiny" or "yolox_custom"
    ...
    """
    from bytetrackx.exp import get_exp, Exp
...
def yolox_nano(pretrained: bool = True, num_classes: int = 80, device: str = None) -> nn.Module:
    return create_yolox_model("bytetrackx-nano", pretrained, num_classes, device)


def yolox_tiny(pretrained: bool = True, num_classes: int = 80, device: str = None) -> nn.Module:
    return create_yolox_model("bytetrackx-tiny", pretrained, num_classes, device)


def yolox_s(pretrained: bool = True, num_classes: int = 80, device: str = None) -> nn.Module:
    return create_yolox_model("bytetrackx-s", pretrained, num_classes, device)


def yolox_m(pretrained: bool = True, num_classes: int = 80, device: str = None) -> nn.Module:
    return create_yolox_model("bytetrackx-m", pretrained, num_classes, device)


def yolox_l(pretrained: bool = True, num_classes: int = 80, device: str = None) -> nn.Module:
    return create_yolox_model("bytetrackx-l", pretrained, num_classes, device)


def yolox_x(pretrained: bool = True, num_classes: int = 80, device: str = None) -> nn.Module:
    return create_yolox_model("bytetrackx-x", pretrained, num_classes, device)
